...
echo "Building AOT-optimized Photino.NET application for macOS (Apple Silicon ARM64)..."
...
echo ""
echo "AOT publish for macOS (ARM64):"
...
OUTPUT_PATH="$PROJECT_DIR/bin/Release/net8.0/osx-arm64/publish/"

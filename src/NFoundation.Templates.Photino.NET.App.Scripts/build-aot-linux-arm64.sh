...
echo "Building AOT-optimized Photino.NET application for Linux (ARM64)..."
...
echo ""
echo "AOT publish for Linux (ARM64):"
...
OUTPUT_PATH="$PROJECT_DIR/bin/Release/net8.0/linux-arm64/publish/"
...
echo ""
echo "Note: This binary is optimized for ARM64 processors"
echo "      (Raspberry Pi 4+, ARM-based cloud instances, etc.)"
echo "========================================"